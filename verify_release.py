"""Readable pre-build verification for Omega Horizon V9.6.3."""
...
check("build id",g.BUILD_ID=="V9.6.3-STAGE2-ATMOSPHERIC-DESCENT",g.BUILD_ID)
check("display version",g.DISPLAY_VERSION=="V9.6.3",g.DISPLAY_VERSION)
check("display subtitle",g.DISPLAY_SUBTITLE=="STAGE 2 ATMOSPHERIC DESCENT",g.DISPLAY_SUBTITLE)
check("Stage 1 ringed asset retained",g.STAGE1_FLAGSHIP_ASSET=="assets/stage01_space_v9621.png",g.STAGE1_FLAGSHIP_ASSET)
...
for rel in (
    ...
    "assets/stage01_space_v9621.png","assets/stage05_station_v961.png","assets/stage08_ice_v961.png","assets/stage09_nebula_v961.png",
...
print("V9.6.3 RELEASE VERIFICATION OK")
